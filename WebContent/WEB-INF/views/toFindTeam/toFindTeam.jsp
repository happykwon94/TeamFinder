						...
						<div class="highlights">
							<c:forEach var="post" items="${posts}">
								<section>
									<div class="content">
										<header>
											<a href="/TeamFinder/toFindTeamDetail" class="icon fa-vcard-o" style="vertical-align: middle"><span class="label">Icon</span></a><span style="vertical-align: middle">&nbsp${post.user.user_id}</span>
											<h3>${post.title}</h3>
										</header>
										<p>
